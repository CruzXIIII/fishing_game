    ...
    while True:
        ...
        if choice == '1':
            if not player.inventory:
                ...
                player.inventory = []
                player.save()
                if winsound: winsound.Beep(1000, 100); if winsound: winsound.Beep(1200, 100)
            ...
            if winsound: winsound.Beep(150, 300)
    ...
    while True:
        ...
        if choice == '1':
            if player.remove_money(15000):
                ...
                player.save()
                if winsound: winsound.Beep(1200, 100); if winsound: winsound.Beep(1600, 150)
